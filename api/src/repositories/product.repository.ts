...
export class ProductRepository {
  ...
  async update(
    ...
    if (productData.oldPrice !== undefined)
      updateData.oldPrice = productData.oldPrice?.toString();
    if (productData.images !== undefined)
      updateData.images = productData.images;
    if (productData.category !== undefined)
      updateData.category = productData.category;
    if (productData.stock !== undefined)
      updateData.stock = productData.stock.toString();
    if (productData.slug !== undefined) updateData.slug = productData.slug;
    if (productData.sizes !== undefined)
      updateData.sizes = productData.sizes as string[];
    if (productData.isNewDrop !== undefined)
      updateData.isNewDrop = productData.isNewDrop;
    if (productData.isFeatured !== undefined)
      updateData.isFeatured = productData.isFeatured;
