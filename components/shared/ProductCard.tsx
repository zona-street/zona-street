...
export function ProductCardFeatured({
  ...
  return (
    <Card className="group pt-0 relative overflow-hidden border-2 border-gray-900 bg-white shadow-brutal-lg transition-all hover:translate-x-[6px] hover:translate-y-[6px] hover:shadow-none gap-0 rounded-none">
      <CardHeader className="p-0">
        <Link
          href={`/produtos/${slug}`}
          className="relative block aspect-square"
